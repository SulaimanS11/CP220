 ...
 */
struct WORD  {
    char word[20];   /* The character array that holds the actual string of a word */
    int count;     /* Keeps track of how many times this particular word appears in the text */
};
...
typedef struct WORDSTATS WORDSTATS;
